...
from rectools.models.bayesprob_mf_raw_v3 import fit


class BayesProbMF_V3(VectorModel):
    """
    ...
    def _fit(self, dataset: Dataset) -> None:  # type: ignore
        ...
        u, v = fit(ratings, n_user=n_user, n_item=n_item, 
        ...
        # fit(ratings, n_user=n_user, n_item=n_item, n_feature=10, max_rating=5., min_rating=1., seed=0, n_iters=4);
